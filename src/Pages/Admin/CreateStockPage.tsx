// Ruta: src/Pages/Admin/CreateStockPage.tsx (CORREGIDO)
...
const CreateStockPage = () => {
  ...
  const onSubmit: SubmitHandler<StockFormInputs> = async (data) => {
    ...
    const payload: StockPost = {
      ...data, // Copiamos los campos que ya son string (symbol, companyName, etc.)
    ...
    // 3. Enviamos el 'payload' corregido a la API.
  ...
  return (
    <div className="flex flex-col items-center mt-10">
      <div className="w-full max-w-xl p-8 space-y-6 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-bold text-center text-gray-800">Crear Nueva Acción</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {/* El HTML del formulario no cambia, ya es correcto */}
          <div>
